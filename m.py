...
bot = telebot.TeleBot('7598904647:AAHER78zynGXHJVM3oICJAtk0oKD4fo_39M')

# Admin user IDs
ADMIN_IDS = ["6040233308"]
...
def handle_attack(message):
    ...
    if user_data is None:
        bot.reply_to(message, "🚫 You are not authorized to use this bot PAPA SE BAAT KARO @TG_FLASH92.")
        return
